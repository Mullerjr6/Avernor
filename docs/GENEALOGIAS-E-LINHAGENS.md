...
Execute `npm run validate:genealogies`. Além das verificações cronológicas e referenciais, o script exige ao menos 18 árvores, 120 pessoas, cinco membros por árvore, conectividade, metadados editoriais completos, retrato ou fallback heráldico, enums válidos, distinção real entre parentesco, ofício e custódia e expectativa de vida compatível com o povo. Exceções de longevidade precisam de justificativa canônica explícita; lacunas permanecem classificadas.
