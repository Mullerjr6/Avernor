...
const curatedItems = [
  ...
  { src: '/assets/images/maps/avernor-map-atlas-large.webp', thumb: '/assets/images/maps/avernor-map-atlas-preview.webp', title: 'Atlas contemporâneo', kind: 'Carta canônica', alt: 'Mapa ilustrado contemporâneo do continente de Avernor' },
  { src: '/assets/images/maps/avernor-map-historical-large.webp', thumb: '/assets/images/maps/avernor-map-historical-preview.webp', title: 'Carta histórica — 1024 d.C.', kind: 'Carta histórica', alt: 'Carta histórica ilustrada de Avernor com reinos e rotas antigas' },
  { src: '/assets/images/maps/avernor-map-parchment-large.webp', thumb: '/assets/images/maps/avernor-map-parchment-preview.webp', title: 'Carta alternativa das coroas', kind: 'Estudo cartográfico', alt: 'Mapa alternativo de Avernor em pergaminho escuro' },
  { src: '/assets/images/maps/avernor-map-main-large.webp', thumb: '/assets/images/maps/avernor-map-main-preview.webp', title: 'Carta principal de Avernor', kind: 'Carta canônica', alt: 'Mapa principal do continente de Avernor' },
  { src: '/assets/images/maps/avernor-map-regions-large.webp', thumb: '/assets/images/maps/avernor-map-regions-preview.webp', title: 'Carta regional de Avernor', kind: 'Estudo cartográfico', alt: 'Mapa regional do continente de Avernor' },
  { src: '/assets/images/maps/avernor-map-alt-01-large.webp', thumb: '/assets/images/maps/avernor-map-alt-01-preview.webp', title: 'Carta alternativa de Avernor', kind: 'Estudo cartográfico', alt: 'Mapa alternativo ilustrado do continente de Avernor' },
]
